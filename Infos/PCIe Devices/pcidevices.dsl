DefinitionBlock ("", "SSDT", 2, "HACK", "PCI", 0x00000000)
{
	...
	Device (_SB.PC00.IGPU)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				...
				"model", Buffer () { "Intel Raptor Lake-P [Iris Xe Graphics]" },
	...
	Device (_SB.PC00.PEG0)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Raptor Lake PCIe 4.0 Graphics Port" },
				"device_type", Buffer () { "PCI bridge" },
	...
	Device (_SB.PC00.TRP0)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Raptor Lake-P Thunderbolt 4 PCI Express Root Port #0" },
				"device_type", Buffer () { "PCI bridge" },
	...
	Device (_SB.PC00.TXHC)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Raptor Lake-P Thunderbolt 4 USB Controller" },
	...
	Device (_SB.PC00.TDM0)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Raptor Lake-P Thunderbolt 4 NHI #0" },
				"device_type", Buffer () { "USB controller" },
	...
	Device (_SB.PC00.I2C0)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Alder Lake PCH Serial IO I2C Controller #0" },
	...
	Device (_SB.PC00.I2C1)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Alder Lake PCH Serial IO I2C Controller #1" },
				"device_type", Buffer () { "Serial bus controller" },
	...
	Device (_SB.PC00.I2C4)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Alder Lake-P Serial IO I2C Controller #0" },
				"device_type", Buffer () { "Serial bus controller" },
	...
	Device (_SB.PC00.I2C5)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Alder Lake-P Serial IO I2C Controller #1" },
				"device_type", Buffer () { "Serial bus controller" },
	...
	Device (_SB.PC00.RP10)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Alder Lake PCI Express x1 Root Port #10" },
				"device_type", Buffer () { "PCI bridge" },
	...
	Device (_SB.PC00.UA00)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Alder Lake PCH UART #0" },
				"device_type", Buffer () { "Communication controller" },
	...
	Device (_SB.PC00.SPI1)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Alder Lake SPI Controller" },
				"device_type", Buffer () { "Serial bus controller" },
	...
	Device (_SB.PC00.LPCB)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Raptor Lake LPC/eSPI Controller" },
	...
	Device (_SB.PC00.HDEF)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Raptor Lake-P/U/H cAVS" },
	...
	Device (_SB.PC00.GLAN)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Ethernet Connection (16) I219-V" },
